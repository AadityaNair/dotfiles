...
# NOTE: Fish has no API to highlight part of the commandline buffer without using selection mode (which breaks editing).
#       So we cannot hightlight the query string.
