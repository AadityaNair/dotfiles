...
apply_theme() {
    ...
    status_right="︎#[fg=$time_date_fg,nobold]$right_separator %R $right_separator %a %d %b #[fg=$host_bg]$right_separator_black#[fg=$host_fg,bg=$host_bg] #(uptime | sed -e "s/.*://" | cut -d "," -f 1) $right_separator IP #{cpu_percentage} "
